...
from utils.functions import pairwise_distances
from utils.core import create_nshot_task_label
...
def matching_net_episode(binary_model,
    ...
    y_pred = matching_net_predictions(use_gpu, attention, n_shot, k_way, q_queries)
...
def matching_net_predictions(use_gpu, attention: torch.Tensor, n: int, k: int, q: int) -> torch.Tensor:
