...
![heatmap no binary network conv1](results/MNIST_results/heatmap_png/heatmapNonBinaryNet_conv1.png =150x150)
heatmap Stochastic binary network with ST, conv layer1:
![heatmap binary network Stochastic ST conv1](results/MNIST_results/heatmap_png/heatmapStochastic_ST_first_conv_binary_conv1.png =150x150)
